...
app.post('/', (request, response) => {
    ...
    var statement = `Insert into users(driving_license, first_name, middle_name, last_name, contact, email, password, aadhar_no, pan_no, dob, gender, status) 
                        values('${driving_license}','${first_name}','${middle_name}','${last_name}','${contact}','${email}','${password}','${aadhar_no}','${pan_no}','${dob}','${gender}', '${status}')`;
